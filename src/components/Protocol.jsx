    ...
    <section id="process" className="py-24 bg-surface/30">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 text-foreground">My Development Process</h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-1 bg-gray-200 dark:bg-white/10 -translate-x-1/2"></div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className={`relative flex flex-col md:flex-row items-start md:items-center gap-8 group ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  {/* Content */}
                  <div className="ml-12 md:ml-0 md:w-1/2 p-6 bg-surface border border-gray-200 dark:border-white/5 rounded-2xl hover:border-primary/50 transition-colors shadow-sm dark:shadow-none">
                  ...
                  {/* Center Dot */}
                  <div className="absolute left-[20px] md:left-1/2 w-12 h-12 -translate-x-1/2 bg-background border-4 border-gray-100 dark:border-white/10 rounded-full flex items-center justify-center z-10 transition-all duration-500 group-hover:scale-110 group-hover:border-primary group-hover:bg-primary group-hover:shadow-[0_0_15px_rgba(var(--primary),0.5)]">
